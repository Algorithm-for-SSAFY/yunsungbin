...
### 접근 방법
- 그래프 이론을 적용했습니다.
- 처음에 DFS로 풀었으나, 시간초과가 뜨고.. 서칭해본 결과 메모이제이션을 써야한다고 해서, BFS로 다시 풀었습니다!
- 코드를 보시면, DFS랑 BFS 둘다 있습니다 ㅎㅎ;
- 문제의 함정은 입력 값의 순서입니다. n1, n2를 받는다면 n1 -> n2를 넣는 것이 아니라, 의존 관계가 거꾸로 이므로 n2 -> n1으로 넣어야합니다.

### 회고
- 시간 복잡도를 미리 계산해서 알고리즘 가능 여부를 판단하는 능력이 필요한 것 같습니다..
