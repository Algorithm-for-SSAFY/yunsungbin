...
- 가중치가 없는 인접 리스트를 사용 했습니다.
- 오늘 수업 중 배운 내용으로 이중 while문을 사용하였으며, depth가 2가 된 경우 break시켜, queue에 담긴 값들이 최단거리 K로 도달 할 수 있는 노드들이므로 정렬 후 출력했습니다.
