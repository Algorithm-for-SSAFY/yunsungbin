...
- 이 문제는 교재를 보고 거의 클론 코딩으로 풀어서 풀었다 라고 말하기 조금 힘든 상태입니다.
- 최소 공배수와 최대 공약수의 활용 방법이 아직 미숙하여, 응용 방법에 대해 좀 더 익숙해져야 겠다 생각하게 되었습니다.
- 우선 간선 정보와 가중치가 주어지면, A -> B , B -> A 로 갈때 역수 처리가 된다는 것을 생각해야 했습니다.
- 임의의 점을 최소 공배수로 설정한 후, 가중치에 따라 다른 노드들을 채운 후, 최대공약수로 나누었습니다 ( 교재가 그러랍니다 ! )
- 추후에 한 번 더 풀어봐야 하는 문제입니다.
